...
class Usuario {
    ...
    listaUsuariosValidos() {
        ...
        lista.push(new Usuario('cfuentes@duocuc.cl', 'asdf', 'Carla Fuentes González', 'Lugar de nacimiento de su madre', 'Valparaíso'));
        return lista;
    }
    ...
    buscarUsuarioValidoCorreo(correo) {
        return this.listaUsuariosValidos().find(usu => usu.correo === correo);
    }
    //------------------------------------buscar usuario valido (correo)
    buscarUsuarioValidoRespSecret(respuestaSecreta, correo) {
        return this.listaUsuariosValidos().find(usu => usu.respuestaSecreta === respuestaSecreta && usu.correo === correo);
    }
    //------------------------------------validador: nombre
    validarCorreo() {
        if (this.correo.trim() === '') {
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_home_BASTARDO_ProyectosIonic_Control1_Barboza_Tapia_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_home_BASTARDO_ProyectosIonic_Control1_Barboza_Tapia_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_home_BASTARDO_ProyectosIonic_Control1_Barboza_Tapia_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
