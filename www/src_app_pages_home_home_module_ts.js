...
class Asignatura {
    //------------------------------------constructor
    constructor(sede, sigla, seccion, nombreAsignatura, nombreProfesor, dia, bloqueInicio, bloqueTermino, horaInicio, horaTermino) {
        //------------------------------------variables
        this.sede = '';
        this.sigla = '';
        this.seccion = '';
...
/* harmony import */ var src_app_model_Asignatura__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/model/Asignatura */ 9909);
...
let HomePage = class HomePage {
  ...
  constructor(activeroute, router, alertController, loadingController, toastController) {
  ...
  mostrarQrOrdenados(datosQR) {
    //pasar el string, a json object
    const objetoDatosQr = JSON.parse(datosQR); //instanciar parametros pelados

    this.datosAsignatura = new src_app_model_Asignatura__WEBPACK_IMPORTED_MODULE_3__.Asignatura('', '', '', '', '', '', 0, 0, '', ''); //parear con las variables
  ...
  limpiarDatos() {
    ...
    this.loading = null;
    document.getElementById('input-file').value = ''; //javascript 
  } //------------------------------método detener
...
"use strict";
module.exports = ".qrcode {\n  width: 80%;\n  align-items: center;\n  justify-content: center;\n}\n\n.logo {\n  width: 50%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
